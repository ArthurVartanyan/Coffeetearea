if (localStorage.getItem('token') !== null) {
    ...
    const requestURL = '/api/tea/all?page_size=100000'
    ...
    xhr.onload = () => {
        ...
        for (let i = 0; i < datas.content.length; i++) {
            ...
            editButton.onclick = function () {
                ...
                const getCoffeeUrl = "/api/tea/" + ids;

                const teaXHR = new XMLHttpRequest();

                teaXHR.open('GET', getCoffeeUrl)

                teaXHR.setRequestHeader('Authorization', localStorage.getItem('token'))
                ...
                teaXHR.onload = () => {
                    ...
                    image2.src = 'http://localhost:8080/api/drinks/' + ids + '/image'

                    document.body.appendChild(image2)


                    var teaDannie = JSON.parse(teaXHR.response)

                    var namee = teaDannie.name;
                    var pricee = teaDannie.price;
                    var weighte = teaDannie.weight;
                    var typee = teaDannie.teaType.name;
                    var manufee = teaDannie.manufacturer.name;
                    var packagee = teaDannie.packaging.name;
                    var colorr = teaDannie.teaColor.name;
                    var countriee = teaDannie.country.name;
                    var aboutee = teaDannie.about;
                    ...
                    const requestURL = '/api/catalogs/tea-types'
                    ...
                    // addCountry.textContent = countriee;
                    ...
                    const roastURL = '/api/catalogs/tea-colors'
