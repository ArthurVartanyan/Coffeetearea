function createTeaCardsFilter(number = '0', sortingParams = 'NAME_INCREASE',
    ...
    xhrFilt.onload = () => {
        ...
        for (let i = 0; i < datas.content.length; i++) {
            ...
            name.onclick = function () {
                ...
                document.getElementById('tea-filter').remove()
                document.getElementById('cards').remove()
                document.getElementById('paginationTea').remove()
